...
const PropertiesManagerEnhanced = () => {
                  ...
                  <TableCell>
                    {property.slug && (
                      <Button
                        ...
                        onClick={() => window.open(`/${property.slug}`, '_blank')}
                      >
                        /{property.slug} <ExternalLink className="h-3 w-3 ml-1" />
                      </Button>
                    )}
                  </TableCell>
                  <TableCell>
...
export default PropertiesManagerEnhanced;
